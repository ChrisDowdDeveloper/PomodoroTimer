...
export default function Timer({session, isTimerRunning, focusDuration, breakDuration}) {
...
(session.label === "Focusing" ? focusDuration * 60 : breakDuration * 60)}%` }} // TODO: Increase width % as elapsed time increases
           />
           </div>
         </div>
       </div>
